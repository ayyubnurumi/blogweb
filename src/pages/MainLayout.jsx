  ...
  return (
    <>
      ...
      >
        <div className="container-fluid">
          ...
          <ul className="nav navbar-nav ms-auto gap-2">
            ...
            <li className="nav-item">
              <Link className="nav-link d-none d-md-block" to="/membership">
                Membership
              </Link>
            </li>
            <li className="nav-item">
            ...
            <li className="nav-item">
              <Link
                className="nav-link btn btn-dark rounded-pill px-3 text-light"
                to={"/signin"}
              >
                Get Started
              </Link>
      ...
      <footer className="container-fluid bg-dark pt-2 d-lg-none">
        ...
        <nav className="nav">
          <Link className="nav-link link-light ps-0" to="/about">
            About
          </Link>
